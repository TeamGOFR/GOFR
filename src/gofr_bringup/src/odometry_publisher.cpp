...
#define WHEEL_DIA .0762 //0.254 for 10 inch
#define PULSE_REV 660
...
OdometryPublisher::OdometryPublisher()
{
	...
	nh_priv.param("scale_x", scale_x, WHEEL_DIA*PI/PULSE_REV); // loosely base off of 360 counts per rev, 100mm wheels (which is 0.6283185 / 360.0)
	nh_priv.param("scale_y", scale_y, WHEEL_DIA*PI/PULSE_REV);
	nh_priv.param("scale_th", scale_th, 0.0016);
